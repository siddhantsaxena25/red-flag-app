...
class ReportConfirmationScreen extends StatefulWidget {
  ...
  static const routeName = "./report_confirmation_screen"; 

  @override
  _ReportConfirmationScreenState createState() => _ReportConfirmationScreenState();
}
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(ReportedCaseDetailsScreen.routeName);
                },
                child: Text(
